	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="${pageContext.request.contextPath }/health_Insurance/main.action" class="active">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="col-md-12 text-right">
						<itheima:page url="${pageContext.request.contextPath }/health_Insurance/main.action" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
