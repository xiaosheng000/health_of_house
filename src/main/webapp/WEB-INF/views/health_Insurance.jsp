...
<div id="wrapper">
	...
	<div class="navbar-default sidebar" role="navigation">
		<div class="sidebar-nav navbar-collapse">
			<ul class="nav" id="side-menu">
				...
				<li>
				    <a href="${pageContext.request.contextPath }/xiaosheng/health_Insurance/main.action" class="active">
  ...
  <!-- 客户列表查询部分  start-->
	<div id="page-wrapper">
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">客户医保管理</h1>
			</div>
			<!-- /.col-lg-12 -->
		</div>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">客户医保信息列表</div>
					<!-- /.panel-heading -->
					...
					<div class="col-md-12 text-right">
						<itheima:page url="${pageContext.request.contextPath }/xiaosheng/health_Insurance/main.action" />
					</div>
					<!-- /.panel-body -->
				</div>
				<!-- /.panel -->
